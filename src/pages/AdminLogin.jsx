    ...
    <div className="min-h-screen bg-[#070a13] text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900/40 border border-slate-800/80 rounded-3xl p-8 backdrop-blur-md shadow-2xl">
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-slate-400">Sign in to manage your portfolio</p>
        </div>
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full bg-slate-950/60 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-sm  placeholder-slate-500 focus:outline-none focus:border-blue-500"

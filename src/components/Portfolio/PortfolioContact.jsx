...
function PortfolioContact() {
  return (
    <section className='bg-[#161f4a] text-white py-20 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-6xl mx-auto rounded-[2rem] border border-white/10 bg-white/5 p-10 sm:p-12 shadow-2xl'>
        <div className='grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-center'>
          ...
          <div className='rounded-3xl bg-[#0f1a3c]/90 p-8 border border-white/10'>
            ...
            <a
              ...
              className='mt-8 inline-flex w-full items-center justify-center rounded-full bg-blue-500 px-6 py-3 text-sm font-bold uppercase tracking-[0.2em] text-white transition hover:bg-blue-400'
            >
              Email me
            </a>
          </div>
